...
`nn_practical_solution.ipynb`, `11_neural_networks.qmd`, and the practicals of chapters 02-04 and
...
work (ties to the GraphCast frame already in `40_intro_history`). Better as a bonus than a
flagship.
