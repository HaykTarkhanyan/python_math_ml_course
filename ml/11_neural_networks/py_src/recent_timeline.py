"""Real figure for the 40_intro_history deck (our modern-applications addendum).
...
Run with the project venv:
    ./ma/Scripts/python.exe ml/11_neural_networks/py_src/recent_timeline.py
"""
