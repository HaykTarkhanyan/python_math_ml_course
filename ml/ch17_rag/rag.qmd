---
title: "17 RAG — որոնում և գեներացիա"
---
...
::: {.callout-note}
Հենվում է **ch7-ի (word2vec, բառային վեկտորներ, cosine similarity)** և **ch9-ի (attention, encoder-ներ)** վրա։ L41-ը **չի** վերաուսուցանում բառային վեկտորները — ենթադրում է, որ դրանք արդեն տեսել եք L21-ում։
:::
