# Dimensionality-reduction deck (ml/10_dimensionality_reduction) - content & teaching review

Reviewed 2026-07-07 (Claude). Scope: `35_dimensionality_reduction.tex` (29 slides / 34
rendered pages), `35_dimensionality_reduction_OUTLINE.md`, all figures in `fig/`, the generator
`py_src/dimred_demos.py`, and a glance at `37_eigenfaces_solution.ipynb`. Method: close read of
