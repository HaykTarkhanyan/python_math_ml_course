...
ml/ch5_neural_networks/data/surnames_hy.txt (one lowercased surname per line, sorted),
...
Run with the project venv:
    ./ma/Scripts/python.exe ml/ch5_neural_networks/py_src/fetch_surnames.py
"""
