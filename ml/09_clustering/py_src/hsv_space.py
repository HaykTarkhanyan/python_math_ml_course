"""Figure for 33_color_spaces (Section 2, the HSV colour space).

Generates into ml/09_clustering/fig/:
  hsv_space.pdf  -- top row: the Saryan landscape decomposed into H, S, V.
...
def main():
    log = setup_logging("color_hsv_space")
