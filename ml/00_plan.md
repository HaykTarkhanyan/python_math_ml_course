...
- **[12] Classification metrics** — accuracy → precision/recall/F1 → ROC AUC → PR AUC → lift, plus threshold tuning (cost-sensitive, `TunedThresholdClassifierCV`) (built: `L12_classification_metrics__threshold_tuning`)
