...
- **Դիագնոստիկան դատավճիռ չէ։** Part 3-ը ADF/KPSS-ով և դիսպերսիայով կառուցում է համոզիչ փաստարկ `d=0`-ի օգտին, իսկ Part 5-ում հենց այդ մոդելը **վերջին տեղն է զբաղեցնում**։ Ներսի դիագնոստիկան նկարագրում է train-ը, ոչ թե կանխատեսումը։

Notebook-ը կատարվում է ամբողջությամբ ~30 վայրկյանում, CPU-ի վրա (62 cell, 8 գրաֆիկ, 0 սխալ)։
