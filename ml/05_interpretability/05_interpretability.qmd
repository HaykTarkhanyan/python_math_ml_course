...
::: {.callout-note}
📝 Սլայդերը պատրաստ են (ներքևում)։ **[22]–[23]** դասերը անցկացված են, **[24]–[25]**-ը դեռ չեն ձայնագրվել։
:::
...
- **[24] SHAP & LIME** — the **Shapley value** from cooperative game theory (Shapley, 1953), worked by hand, then the four SHAP plots (waterfall, bar, beeswarm, dependence). **LIME** step by step — sample, weight by proximity, fit a local surrogate — and **counterfactual explanations** as an optimization problem (validity, proximity, sparsity, plausibility, actionability). [PDF](https://github.com/HaykTarkhanyan/python_math_ml_course/blob/main/ml/05_interpretability/24_shap_lime.pdf)
