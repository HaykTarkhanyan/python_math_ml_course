"""Generate a self-contained Apps Script (questions embedded) for the libraries test.

Produces build_form_selfcontained.gs that you paste into an Apps Script project
and run buildForm() - no Drive upload needed. Question titles are numbered 1., 2., ...
...
CSV = HERE / "python_libs_understanding_test.csv"
OUT = HERE / "build_form_selfcontained.gs"

FORM_TITLE = "Python Libraries Understanding Test"
FORM_DESCRIPTION = (
...
def main():
    ...
    gs = f"""/** AUTO-GENERATED self-contained quiz builder (Python libraries test).
