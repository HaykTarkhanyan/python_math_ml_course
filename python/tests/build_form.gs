 ...
 * python_understanding_test.csv. One section per area, in course order,
...
var FORM_TITLE = 'Python Understanding Test';
var FORM_DESCRIPTION =
  'A self-assessment of your Python understanding (not memorization). ' +
