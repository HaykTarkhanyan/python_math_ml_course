...
\begin{tikzpicture}[scale=0.88, transform shape]
  ...
  \node[draw=popblue, fill=popblue!15, rounded corners=4pt, inner sep=4pt, font=\scriptsize, text width=2.2cm, align=center] at (-1, 2.0) {
    \textbf{GPT-4}\\{\tiny OpenAI}\\{\tiny Multimodal,\\``sparks of AGI''}
  };
  \node[draw=violet1, fill=violet1!15, rounded corners=4pt, inner sep=4pt, font=\scriptsize, text width=2.2cm, align=center] at (1.5, 2.0) {
    \textbf{Mixtral}\\{\tiny 8$\times$7B, Mistral}\\{\tiny Open MoE,\\near GPT-3.5}
  };
  ...
  % Key themes
  \node[font=\small\bfseries, text=popblue] at (0, 0.3) {Key themes of the post-GPT-3 era};

  \node[draw=orange1, fill=orange1!8, rounded corners=4pt, text width=3.4cm, align=center, inner sep=5pt, font=\scriptsize] at (-5, -1.0) {
  ...
  \node[draw=paramgreen, fill=paramgreen!8, rounded corners=4pt, text width=3.4cm, align=center, inner sep=5pt, font=\scriptsize] at (-1.5, -1.0) {
  ...
  \node[draw=popblue, fill=popblue!8, rounded corners=4pt, text width=3.4cm, align=center, inner sep=5pt, font=\scriptsize] at (2, -1.0) {
    \textbf{\textcolor{popblue}{Multimodal + reasoning}}\\[2pt]
    GPT-4, Gemini, Claude:\\vision, audio, tool use,\\extended thinking
  };

  \node[draw=violet1, fill=violet1!8, rounded corners=4pt, text width=3.4cm, align=center, inner sep=5pt, font=\scriptsize] at (5.5, -1.0) {
  ...
  % Bridge note
  \node[draw=popblue, fill=popblue!10, rounded corners=6pt, text width=13cm, align=center, inner sep=5pt, font=\small] at (0, -2.8) {
