...
\begin{tikzpicture}
  ...
  % Two phases
  \node[draw=paramgreen, fill=paramgreen!8, rounded corners=8pt, text width=5cm, align=center, inner sep=6pt, font=\small] at (-3.5, 1.3) {
  ...
  \node[draw=orange1, fill=orange1!8, rounded corners=8pt, text width=5cm, align=center, inner sep=6pt, font=\small] at (3.5, 1.3) {
...
\begin{tikzpicture}
  ...
  % Three innovations
  \node[draw=paramgreen, fill=paramgreen!8, rounded corners=6pt, text width=3.3cm, align=center, inner sep=5pt, font=\small] at (-4.5, 1.2) {
  ...
  \node[draw=orange1, fill=orange1!8, rounded corners=6pt, text width=3.3cm, align=center, inner sep=5pt, font=\small] at (0, 1.2) {
  ...
  \node[draw=violet1, fill=violet1!8, rounded corners=6pt, text width=3.3cm, align=center, inner sep=5pt, font=\small] at (4.5, 1.2) {
  ...
  % Memory comparison
  \node[font=\small\bfseries, text=popblue] at (0, -0.3) {Memory comparison (65B model fine-tuning):};
  ...
  % Result
  \node[draw=paramgreen, fill=paramgreen!5, rounded corners=6pt, text width=11cm, align=center, inner sep=5pt, font=\small] at (0, -2.7) {
    \textbf{Key result:} QLoRA matches 16-bit LoRA quality on all benchmarks.\\
    Guanaco (QLoRA-tuned LLaMA 65B) reached \textbf{99.3\%} of ChatGPT quality on Vicuna benchmark.
  };
...
\begin{tikzpicture}[scale=0.88, transform shape]
  \node[draw=popblue, fill=popblue!8, rounded corners=8pt, text width=13cm, align=left, inner sep=8pt] at (0, 2.5) {
    ...
    \textbullet~Radford et al.\ (2019), ``GPT-2'' --- causal language modeling\\[2pt]
    \textbullet~Clark et al.\ (2020), ``ELECTRA: Pre-training Text Encoders as Discriminators''
    }
  };
  \node[draw=paramgreen, fill=paramgreen!8, rounded corners=8pt, text width=13cm, align=left, inner sep=8pt] at (0, 0.3) {
    ...
    {\small
    \textbullet~Ouyang et al.\ (2022), ``Training language models to follow instructions with human feedback'' (InstructGPT)\\[2pt]
    \textbullet~Rafailov et al.\ (2023), ``Direct Preference Optimization'' (DPO)\\[2pt]
    \textbullet~Shao et al.\ (2024), ``DeepSeekMath: Pushing the Limits of Mathematical Reasoning'' (GRPO)\\[2pt]
    \textbullet~Bai et al.\ (2022), ``Constitutional AI: Harmlessness from AI Feedback'' (CAI / RLAIF)
    }
  };
  \node[draw=orange1, fill=orange1!8, rounded corners=8pt, text width=13cm, align=left, inner sep=8pt] at (0, -2) {
