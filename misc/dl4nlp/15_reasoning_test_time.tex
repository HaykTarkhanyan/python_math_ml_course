...
\begin{tikzpicture}
  ...
  \filldraw[orange1] (-0.3, 0.7) circle (3pt);
  \node[font=\scriptsize, text=orange1, left] at (-0.5, 0.7) {QwQ};
  \filldraw[warnred] (1, 1.3) circle (3pt);
  \node[font=\scriptsize, text=warnred, right] at (1.2, 1.3) {Claude ext.};
...
\begin{tikzpicture}
  ...
  % Benchmarks
  \node[draw=orange1, fill=orange1!5, rounded corners=6pt, text width=10cm, align=center, inner sep=5pt, font=\small] at (-0.5, -1.8) {
  ...
  \node[draw=violet1, fill=violet1!5, rounded corners=6pt, text width=10cm, align=center, inner sep=4pt, font=\scriptsize] at (-0.5, -3) {
    \textbf{Other reasoning models:} \textbf{QwQ} (Qwen, Nov 2024) --- open-weight 32B reasoning model;
    \textbf{Claude 3.5 Sonnet extended thinking} (Anthropic, 2025) --- user-controllable thinking budget.
  };
\end{tikzpicture}
\end{center}
\end{frame}
...
\begin{tikzpicture}
  ...
  \node[draw=violet1, fill=violet1!5, rounded corners=6pt, text width=5cm, align=center, inner sep=5pt, font=\scriptsize] at (-4, 0.3) {
    ...
    \textbf{pure RL} (GRPO) on the base model,\\
    \textbf{no supervised fine-tuning}!\\[4pt]
    Emergent: self-verification,\\``aha moments,'' long CoT
  };
...
\begin{tikzpicture}
  ...
  % Late 2024 events
  \node[draw=orange1, fill=orange1!8, rounded corners=4pt, font=\scriptsize, text width=1.5cm, align=center, inner sep=3pt] at (3.8, 2.2) {QwQ};
  \draw[thick, orange1] (3.8, 0.15) -- (3.8, 1.8);

  % 2025 events
  \node[draw=warnred, fill=warnred!8, rounded corners=4pt, font=\scriptsize, text width=2.2cm, align=center, inner sep=3pt] at (5, 1.5) {DeepSeek-R1\\s1, Claude ext.};
...
\begin{tikzpicture}
  ...
  \node[draw=warnred, fill=warnred!8, rounded corners=6pt, text width=3.5cm, align=center, inner sep=5pt, font=\scriptsize] at (0, 0.2) {
    ...
    $\to$ DeepSeek-R1, QwQ,\\or distilled variants
  };
...
\begin{tikzpicture}[scale=0.88, transform shape]
  ...
  \node[draw=paramgreen, fill=paramgreen!8, rounded corners=8pt, text width=13cm, align=left, inner sep=8pt] at (0, 0.3) {
    ...
    \textbullet~DeepSeek-AI (2025), ``DeepSeek-R1: Incentivizing Reasoning Capability in LLMs via RL''\\[2pt]
    \textbullet~Qwen Team (2024), ``QwQ: Reflect Deeply on the Boundaries of the Unknown''
    }
  };
