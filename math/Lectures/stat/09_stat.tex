...
{\footnotesize\textcolor{warnred}{\textbf{Warning:} Cohen's benchmarks (0.2/0.5/0.8) are \textbf{context-dependent}. Always define the \textbf{smallest effect size of interest} (SESOI) from domain knowledge, not from a table.}}\\
{\footnotesize\textcolor{warnred}{\textbf{Context matters:} In medicine, $d = 0.1$ applied to millions can save thousands of lives. In education, $d = 0.8$ is extraordinarily rare. Always interpret effect sizes in your domain.}}
\end{frame}
