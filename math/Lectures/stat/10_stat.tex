...
\vspace{0.1cm}
$t_{7, 0.025} = 2.365$. Since $|T| = 6.39 \gg 2.365$: \textbf{reject} $H_0$. The drug works.
\end{frame}
...
\fcolorbox{orange1}{orange1!5}{\parbox{10cm}{\centering\footnotesize
  ...
  The pooled version only gains a tiny bit of power when $\sigma_1 = \sigma_2$.
}}
\end{center}
\end{frame}
...
\fcolorbox{orange1}{orange1!5}{\parbox{10cm}{\centering\small
  ...
  where $\hat{p} = \frac{k_1 + k_2}{n_1 + n_2}$.
}}
\end{center}
\end{frame}
...
\begin{tikzpicture}[
  ...
  % Nonparametric note
  \node[draw=violet1!50, fill=violet1!5, rounded corners=3pt, font=\tiny, text width=3cm, align=center, inner sep=3pt] at (-6.2, -3.2) {Non-Normal? Use\\Mann--Whitney (unpaired)\\or Wilcoxon (paired)};
\end{tikzpicture}
\end{center}
\end{frame}
...
\begin{center}
  ...
  {\large Next: Lecture~11 --- Inference in linear regression}
\end{center}
\end{frame}
