...
\fcolorbox{warnred}{warnred!5}{\parbox{10cm}{\centering\small
  ...
  Otherwise use Wilson. Many stats packages default to Wilson.\\[2pt]
  \footnotesize\textbf{Shortcut (Agresti--Coull):} Just use $\tilde{p} = (k+2)/(n+4)$ with a Wald-style CI. Nearly as good as Wilson!
}}
\end{center}
\end{frame}
