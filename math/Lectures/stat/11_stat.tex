...
\fcolorbox{orange1}{orange1!5}{\parbox{10cm}{\centering\footnotesize
  \textbf{If equal-variance assumption fails:} use \textbf{Welch's ANOVA} (\texttt{scipy.stats.f\_oneway} does this).\\
...
\begin{center}
  \vspace{1.5cm}
  {\Huge\bfseries\textcolor{popblue}{Part IV: A/B Testing}}
...
\begin{center}
  \vspace{1.5cm}
  {\Huge\bfseries\textcolor{popblue}{Part V: A/B Testing Pitfalls}}
...
\begin{enumerate}\setlength{\itemsep}{6pt}
  ...
  \item A 3-way A/B/C test shows: $n_A = 1000$, $k_A = 48$; $n_B = 1000$, $k_B = 55$; $n_C = 1000$, $k_C = 62$.\\
