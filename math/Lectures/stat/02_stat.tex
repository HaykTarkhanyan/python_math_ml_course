...
\frametitle{Homework}
\begin{enumerate}
  \item Go over the \textbf{Data Visualization} topic:\\[4pt]
    {\small\url{https://hayktarkhanyan.github.io/python_math_ml_course/python_libs/06_data_viz.html}}

  \vspace{0.3cm}
  \item Pick a dataset (e.g.\ from \textbf{Kaggle} or \url{http://armstat.am/}) and \textbf{explore} it:\\[4pt]
    {\small compute summary statistics, build histograms, boxplots, scatter plots, ECDF}

  \vspace{0.3cm}
  \item Come up with your own examples of:
    \begin{itemize}
