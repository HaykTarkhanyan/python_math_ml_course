...
\vspace{0.05cm}
\begin{center}
\small Equality iff $Z$ is a \textbf{sufficient statistic} of $Y$ for $X$ (i.e., $X \to Z \to Y$ is also Markov).
\end{center}
\end{frame}
...
\begin{itemize}\setlength{\itemsep}{3pt}
  ...
  \item \textcolor{paramgreen}{\checkmark} Bounded: $0 \leq \text{JSD} \leq \ln 2$ (nats) $= 1$ bit
