...
\fcolorbox{orange1}{orange1!5}{\parbox{11cm}{\centering\small
  \textbf{Uniqueness (Khinchin, 1957):} Shannon entropy is \emph{essentially} the \textbf{only} function
  satisfying continuity, maximality for uniform, and a grouping axiom (up to a constant).
}}
\end{center}
\end{frame}
...
\begin{tikzpicture}[
  ...
  \node[box=violet1] at (0, -1.4) {
    ...
    $D_{\text{KL}}(p \| q)$ units of evidence on average in favor of the truth $p$.
  };
\end{tikzpicture}
\end{center}
