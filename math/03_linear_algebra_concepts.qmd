...
The five problems below are translated from chapter 4 (Structure of Linear Spaces) of [«Կարճ մաթեմ մեքենայական ուսուցման համար»](Lectures/Կարճ մաթեմ մեքենայական ուսուցման համար.pdf), section 4.6 (page 50 of the book / page 56 of the PDF). Original numbering preserved.

### 4.1: Filling in a matrix from constraints {data-difficulty="2"}
...
- (a) the transformation stretches $\begin{pmatrix} 1 \\ 0 \end{pmatrix}$ by a factor of $2$
- (b) the trace is $2$ and the determinant is $3$
- (c) $1$ and $5$ are eigenvalues of the transformation
...
### 4.2: Maximum dimension of a span {data-difficulty="2"}

What is the largest possible dimension of the subspace spanned by these vectors?

- (a) $\vec v_1 = \begin{pmatrix} 6 \\ 1 \\ 5 \end{pmatrix}$, $\vec v_2 = \begin{pmatrix} 2 \\ 3 \\ 2 \end{pmatrix}$

- (b) $\vec v_1 = \begin{pmatrix} 6 \\ 2 \end{pmatrix}$, $\vec v_2 = \begin{pmatrix} 1 \\ 3 \end{pmatrix}$, $\vec v_3 = \begin{pmatrix} 5 \\ 2 \end{pmatrix}$

- (c) $\vec v_1 = \begin{pmatrix} 4 \\ 1 \\ 2 \end{pmatrix}$, $\vec v_2 = \begin{pmatrix} -4 \\ 2 \\ -1 \end{pmatrix}$, $\vec v_3 = \begin{pmatrix} 8 \\ -1 \\ 7 \end{pmatrix}$

- (d) $\vec v_1 = \begin{pmatrix} 3 \\ -2 \\ 1 \end{pmatrix}$, $\vec v_2 = \begin{pmatrix} 6 \\ -4 \\ 4 \end{pmatrix}$
...
### 4.3: Eigenvalues and eigenvectors {data-difficulty="2"}

Find the eigenvalues and eigenvectors of:

- (a) $A = \begin{pmatrix} 1 & 2 \\ 0 & 1 \end{pmatrix}$
- (b) $B = \begin{pmatrix} 2 & 1 \\ 1 & 2 \end{pmatrix}$
- (c) $C = \begin{pmatrix} 8 & 1 \\ 8 & 1 \end{pmatrix}$
- (d) $D = \begin{pmatrix} -1 & 0 & 0 \\ 0 & 1 & 0 \\ 0 & 0 & 3 \end{pmatrix}$
...
### 4.4: Diagonal matrix in $\mathbb{R}^5$ {data-difficulty="1"}
...
- (b) Where does $A$ send the standard basis vectors of $\mathbb{R}^5$?
- (c) What do you think the determinant of $A$ is?
- (d) Can you find the eigenvalues and eigenvectors of $A$?
...
### 4.5: Apple-pear system as $A\vec x = \vec b$ {data-difficulty="1"}
...
- (a) Letting the unknowns be $x_1, x_2$, write the problem as a system.
- (b) Can you express the conditions in the form $\begin{pmatrix} * & * \\ * & * \end{pmatrix} \begin{pmatrix} x_1 \\ x_2 \end{pmatrix} = \begin{pmatrix} * \\ * \end{pmatrix}$, in short $A\vec x = \vec b$?
- (c) Using the inverse formula, try to find $\vec x$.
