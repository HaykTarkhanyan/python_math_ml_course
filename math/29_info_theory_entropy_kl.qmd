...
```python
# Option A — read the provided file:
text = open("assets/panir_hy.txt", encoding="utf-8").read()
...
## 03 ✏️ Source Coding: Huffman & the Kraft Inequality {.bonus-problem data-difficulty="2"}

*Optional.* A source emits 5 symbols with probabilities
