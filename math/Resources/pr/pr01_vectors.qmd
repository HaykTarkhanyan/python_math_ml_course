...
---
title: "Exercise: Finding a Perpendicular Vector"
format: html
---
...
Հարթության կոոդինատական համակարգի սկզբնակետից ելնող վեկտորների հետևյալ բազմություններից յուրաքանչյուրի համար պարզել արդյոք այն գծային ենթատարածություն է. \n
<ul>
  <li>բոլոր վեկտորները որոնց վերջնակետերը ընկած են տրված ուղղի վրա</li>
  <li>բոլոր վեկտորները որոնց վերջնակետերը ընկած չեն տրված ուղղի վրա</li>
  <li>բոլոր վեկտորները որոնց վերջնակետերը ընկած են կոորդինատական համակարգի առաջին քառորդում</li>
  <li>բոլոր վեկտորները որոնց վերջնակետերը ընկած են կոորդինատական համակարգի առաջին կամ երրորդ քառորդում</li>
</ul>
