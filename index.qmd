...
## 🟡 15 FastAPI
::: {.libs collapse="false"}
[📚 Ամբողջական նյութը](python_libs/14_fast_api.ipynb)
:::
:::


::: libs
## 🔴 14 Supabase, Render deployment + Project (15 Friday)
::: {.libs collapse="false"}
[📚 Ամբողջական նյութը]()
:::
:::
...
::: libs
## 🔴 15 Vibe coding (17 Sunday (or perhaps another day))
::: {.libs collapse="false"}
[📚 Ամբողջական նյութը]()
:::
:::
...
- [x] Flask / FastAPI
- [x] Render deployment
- [] Supabase (maybe also proper Postgre VS MySQl bla bla bla)
- [] Vibe coding project
...
- Image, Preimage, Even, Odd, Inverse
